...
def page_mapas_conflicto():   
    st.header("🌍 Mapas de Municipios con Presencia de Grupos Armados en 2020")
    ...
    if uploaded_file is not None:
        ...
        municipios_agc = set([
            "ABRIAQUÍ", "ANDES", "ANZÁ", "APARTADÓ", "ARBOLETES", "ARMENIA", "BARBOSA", "BELLO", "BELMIRA", "BETANIA", "BETULIA",
            "CÁCERES", "CAICEDO", "CAÑASGORDAS", "CAREPA", "CAUCASIA", "CHIGORODÓ", "CIUDAD BOLÍVAR", "COCORNÁ", "CONCORDIA", "COPACABANA",
            "DABEIBA", "EBÉJICO", "EL BAGRE", "FRONTINO", "GIRALDO", "GIRARDOTA", "HELICONIA", "HISPANIA", "ITAGÜÍ", "ITUANGO", "JARDÍN", "LIBORINA",
            "MEDELLÍN", "MURINDÓ", "MUTATÁ", "NARIÑO", "NECHÍ", "NECOCLÍ", "PEQUE", "PUERTO BERRÍO", "PUERTO TRIUNFO", "REMEDIOS", "RIONEGRO", "SABANALARGA",
            "SALGAR", "SAN FRANCISCO", "SAN JERÓNIMO", "SAN JUAN DE URABÁ", "SAN LUIS", "SAN PEDRO DE LOS MILAGROS", "SAN PEDRO DE URABÁ", "SAN ROQUE",
            "SANTA FE DE ANTIOQUIA", "SEGOVIA", "SONSÓN", "SOPETRÁN", "TARAZÁ", "TARSO", "TURBO", "URAMITA", "URRAO", "VALDIVIA", "VALPARAÍSO", "VEGACHÍ",
            "VIGÍA DEL FUERTE", "YALÍ", "YARUMAL", "ZARAGOZA"
        ])
